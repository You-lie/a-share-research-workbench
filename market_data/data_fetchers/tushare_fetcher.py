...
from market_data.data_fetchers.base import BaseFetcher, DataFetchError, RateLimitError, STANDARD_COLUMNS,is_bse_code, is_st_stock, is_kc_cy_stock, normalize_stock_code, _is_hk_market
from market_data.data_fetchers.realtime_types import UnifiedRealtimeQuote, ChipDistribution
...
class TushareFetcher(BaseFetcher):
    ...
    def get_realtime_quote(self, stock_code: str) -> Optional[UnifiedRealtimeQuote]:
        ...
        from market_data.data_fetchers.realtime_types import (
            RealtimeSource,
            safe_float, safe_int
        )
    ...
    def get_main_indices(self, region: str = "cn") -> Optional[List[dict]]:
        ...
        from market_data.data_fetchers.realtime_types import safe_float
